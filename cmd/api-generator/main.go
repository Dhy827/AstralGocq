...
func (g *generator) genRouter(routers []Router) {
	...
	g.WriteString("\"github.com/ProtocolScience/AstralGocq/coolq\"\n")
	g.WriteString("\"github.com/ProtocolScience/AstralGocq/global\"\n")
	g.WriteString("\"github.com/ProtocolScience/AstralGocq/pkg/onebot\"\n")
	g.WriteString(")\n\n")
